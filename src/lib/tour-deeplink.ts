...
export function inflateTourSummaryFromIndexEntry(entry: TourIndexEntry): TourSummary {
  return {
    ...
    departureProvince: entry.departureProvince,
    ...
    destinationProvince: entry.destinationProvince,
    ...
    geoStatus: entry.geoStatus,
    geoConfidence: entry.geoConfidence,
    geoSource: entry.geoSource,
    routeRegion: entry.routeRegion,
