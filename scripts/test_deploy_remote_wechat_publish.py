...
class DeployRemoteWechatPublishTests(unittest.TestCase):
    ...
    def test_remote_script_uploads_inline_images(self):
        html = '<p><img src="inline-images/a.jpg"></p><p><img src="inline-images/b.png"></p><p><img src="inline-images/a.jpg"></p>'
        calls = []
        ...
        self.assertEqual(
            calls,
            [
                ('token123', 'inline-images/a.jpg'),
                ('token123', 'inline-images/b.png'),
            ],
        )
    ...
    def test_remote_script_ignores_external_inline_urls(self):
        html = '<p><img src="https://example.com/a.jpg"></p><p><img src="inline-images/b.png"></p>'
        calls = []
        ...
        self.assertEqual(calls, [('token123', 'inline-images/b.png')])
        self.assertIn('https://example.com/a.jpg', replaced_html)
        self.assertIn('https://wx.example/b.png', replaced_html)
