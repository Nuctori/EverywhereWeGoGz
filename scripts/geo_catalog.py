...
PLACE_ROWS = [
    ...
    # --- 全国高频目的地城市 (数据驱动: title 省份后 token 提取, 2026-08) ---
    # 地级市/州府中心坐标 (稳定常识值). catalog 缺省外城市是省外 tour 错 pin
    # 的根因 (贵州 tour 的唯一候选是「合江门」substring 撞的江门).
    ("贵阳", "中国", "贵州", 26.647, 106.63, ("贵阳", "贵阳市")),
    ("遵义", "中国", "贵州", 27.725, 106.927, ("遵义", "遵义市")),
    ("赤水", "中国", "贵州", 28.575, 105.698, ("赤水", "赤水市")),
    ("安顺", "中国", "贵州", 26.253, 105.946, ("安顺", "安顺市")),
    ("兴义", "中国", "贵州", 25.092, 104.895, ("兴义", "兴义市")),
    ("凯里", "中国", "贵州", 26.566, 107.977, ("凯里", "凯里市")),
    ("成都", "中国", "四川", 30.573, 104.066, ("成都", "成都市")),
    ("宜宾", "中国", "四川", 28.752, 104.643, ("宜宾", "宜宾市")),
    ("绵阳", "中国", "四川", 31.468, 104.679, ("绵阳", "绵阳市")),
    ("广元", "中国", "四川", 32.435, 105.844, ("广元", "广元市")),
    ("乐山", "中国", "四川", 29.552, 103.766, ("乐山", "乐山市")),
    ("昆明", "中国", "云南", 24.88, 102.833, ("昆明", "昆明市")),
    ("大理", "中国", "云南", 25.606, 100.23, ("大理", "大理市")),
    ("丽江", "中国", "云南", 26.872, 100.23, ("丽江", "丽江市")),
    ("腾冲", "中国", "云南", 25.02, 98.491, ("腾冲", "腾冲市")),
    ("芒市", "中国", "云南", 24.433, 98.588, ("芒市",)),
    ("香格里拉", "中国", "云南", 27.826, 99.706, ("香格里拉",)),
    ("西安", "中国", "陕西", 34.341, 108.94, ("西安", "西安市")),
    ("兰州", "中国", "甘肃", 36.061, 103.834, ("兰州", "兰州市")),
    ("敦煌", "中国", "甘肃", 40.142, 94.662, ("敦煌",)),
    ("张掖", "中国", "甘肃", 38.926, 100.45, ("张掖", "张掖市")),
    ("嘉峪关", "中国", "甘肃", 39.772, 98.289, ("嘉峪关",)),
    ("乌鲁木齐", "中国", "新疆", 43.826, 87.617, ("乌鲁木齐", "乌鲁木齐市")),
    ("喀什", "中国", "新疆", 39.47, 75.99, ("喀什", "喀什市")),
    ("吐鲁番", "中国", "新疆", 42.951, 89.189, ("吐鲁番",)),
    ("阿勒泰", "中国", "新疆", 47.845, 88.141, ("阿勒泰",)),
    ("银川", "中国", "宁夏", 38.487, 106.231, ("银川", "银川市")),
    ("太原", "中国", "山西", 37.87, 112.549, ("太原", "太原市")),
    ("长沙", "中国", "湖南", 28.228, 112.939, ("长沙", "长沙市")),
    ("张家界", "中国", "湖南", 29.117, 110.479, ("张家界", "张家界市")),
    ("凤凰", "中国", "湖南", 27.948, 109.6, ("凤凰", "凤凰县")),
    ("武汉", "中国", "湖北", 30.593, 114.305, ("武汉", "武汉市")),
    ("宜昌", "中国", "湖北", 30.692, 111.287, ("宜昌", "宜昌市")),
    ("桂林", "中国", "广西", 25.274, 110.29, ("桂林", "桂林市")),
    ("南宁", "中国", "广西", 22.817, 108.366, ("南宁", "南宁市")),
    ("北海", "中国", "广西", 21.481, 109.12, ("北海", "北海市")),
    ("阳朔", "中国", "广西", 24.778, 110.497, ("阳朔", "阳朔县")),
    ("厦门", "中国", "福建", 24.48, 118.09, ("厦门", "厦门市")),
    ("福州", "中国", "福建", 26.074, 119.297, ("福州", "福州市")),
    ("泉州", "中国", "福建", 24.874, 118.676, ("泉州", "泉州市")),
    ("武夷山", "中国", "福建", 27.756, 118.033, ("武夷山",)),
    ("杭州", "中国", "浙江", 30.274, 120.155, ("杭州", "杭州市")),
    ("宁波", "中国", "浙江", 29.868, 121.544, ("宁波", "宁波市")),
    ("南京", "中国", "江苏", 32.06, 118.797, ("南京", "南京市")),
    ("苏州", "中国", "江苏", 31.299, 120.585, ("苏州", "苏州市")),
    ("青岛", "中国", "山东", 36.067, 120.383, ("青岛", "青岛市")),
    ("济南", "中国", "山东", 36.651, 117.12, ("济南", "济南市")),
    ("泰安", "中国", "山东", 36.2, 117.087, ("泰安", "泰安市")),
    ("郑州", "中国", "河南", 34.747, 113.625, ("郑州", "郑州市")),
    ("黄山", "中国", "安徽", 29.715, 118.338, ("黄山", "黄山市")),
    ("合肥", "中国", "安徽", 31.821, 117.227, ("合肥", "合肥市")),
    ("南昌", "中国", "江西", 28.682, 115.858, ("南昌", "南昌市")),
    ("景德镇", "中国", "江西", 29.269, 117.178, ("景德镇",)),
    ("婺源", "中国", "江西", 29.248, 117.862, ("婺源",)),
    ("大连", "中国", "辽宁", 38.914, 121.615, ("大连", "大连市")),
    ("沈阳", "中国", "辽宁", 41.806, 123.432, ("沈阳", "沈阳市")),
    ("长春", "中国", "吉林", 43.817, 125.324, ("长春", "长春市")),
    ("哈尔滨", "中国", "黑龙江", 45.803, 126.535, ("哈尔滨", "哈尔滨市")),
    ("漠河", "中国", "黑龙江", 52.972, 122.539, ("漠河",)),
    ("呼伦贝尔", "中国", "内蒙古", 49.212, 119.766, ("呼伦贝尔",)),
    ("三亚", "中国", "海南", 18.253, 109.512, ("三亚", "三亚市")),
    ("海口", "中国", "海南", 20.044, 110.199, ("海口", "海口市")),
    ("西宁", "中国", "青海", 36.617, 101.778, ("西宁", "西宁市")),
    ("拉萨", "中国", "西藏", 29.652, 91.172, ("拉萨", "拉萨市")),
    ("石家庄", "中国", "河北", 38.042, 114.515, ("石家庄",)),
    ("承德", "中国", "河北", 40.952, 117.963, ("承德", "承德市")),
    (
        "龙门",
        "中国",
        "广东",
